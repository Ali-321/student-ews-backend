...
# Karena file berada di config/settings/base.py, kita butuh .parent 3 kali untuk sampai ke root
...
DATABASES = {
    'default': {
        ...
        'NAME': 'student_ews_db',
        'USER': 'root',                # Sesuaikan dengan user MariaDB Anda
        'PASSWORD':'admin123',    # Sesuaikan dengan password MariaDB Anda
        'HOST': '127.0.0.1',
        'PORT': '3306',
        'OPTIONS': {
